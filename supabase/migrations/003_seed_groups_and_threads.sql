-- Seed groups table
INSERT INTO groups
  (id, name, description, members, isPublic, activity, createdAt, owner, members_list)
VALUES
...
-- Seed threads table
INSERT INTO threads
  (id, groupId, creatorId, title, description, status, createdAt, deadline, votes, total_members, comments)
VALUES
