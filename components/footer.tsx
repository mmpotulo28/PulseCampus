...
const Footer: React.FC = () => {
  return (
    <footer className="sm:hidden md:hidden lg:flex flex-col w-full border-t border-default-200 bg-primary-50 text-foreground">
      <div className="max-w-7xl mx-auto px-4 py-8 flex flex-col md:flex-row md:items-center md:justify-between gap-8">
        ...
        <div className="flex flex-col items-center md:items-start gap-2">
          ...
          <span className="text-xs text-foreground/60 mt-1 text-center md:text-left">
            Real-time voting, engagement metrics, and transparent
            decision-making for campus groups.
          </span>
        </div>
        {/* Quick Links */}
